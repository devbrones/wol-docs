\doxysection{index.\+py File Reference}
...
\begin{DoxyCompactList}\small\item\em Get information about a You\+Tube Video. \end{DoxyCompactList}\item 
def \mbox{\hyperlink{index_8py_aa6f8d9d8f5a8dc75d7a19b775fb5ea16}{apimod.\+index.\+getdbcount}} ()
\begin{DoxyCompactList}\small\item\em Get data amount. \end{DoxyCompactList}\item 
def \mbox{\hyperlink{index_8py_a03ea03ed8f4892134cd1b3a4fe171a33}{apimod.\+index.\+submv}} ()
\begin{DoxyCompactList}\small\item\em Submit a request. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Variables}
\begin{DoxyCompactItemize}
\item 
\mbox{\label{index_8py_a81b4c0affaa3e8dc432bea887492972a}} 
{\bfseries apimod.\+index.\+app} = Flask(\+\_\+\+\_\+name\+\_\+\+\_\+)
\item 
\mbox{\label{index_8py_afaf9833af3f7a672e15e829fcc146669}} 
int {\bfseries apimod.\+index.\+debug} = 0
\item 
\mbox{\label{index_8py_a926ae37243ca5e1bcc6893c6d2309fb6}} 
{\bfseries apimod.\+index.\+filename}
\item 
\mbox{\label{index_8py_aadad262090ce132586e538f68f2b487a}} 
{\bfseries apimod.\+index.\+level}
\item 
\mbox{\label{index_8py_ae22f7701365cb55b7474d049876043a4}} 
{\bfseries apimod.\+index.\+D\+E\+B\+UG}
\item 
\mbox{\label{index_8py_a177e638d098c78323db014af8e78d274}} 
{\bfseries apimod.\+index.\+format}
\item 
{\bfseries apimod.\+index.\+con}
\item 
\mbox{\label{index_8py_aef3432adc274ee84fdc177355ffdc3e1}} 
...
\mbox{\label{index_8py_a35b86d18072e4b45400f1d8f8976a913}} 
...
\mbox{\label{index_8py_aa6f8d9d8f5a8dc75d7a19b775fb5ea16}} 
\index{index.py@{index.py}!getdbcount@{getdbcount}}
\index{getdbcount@{getdbcount}!index.py@{index.py}}
\doxysubsubsection{\texorpdfstring{getdbcount()}{getdbcount()}}
{\footnotesize\ttfamily def apimod.\+index.\+getdbcount (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}



Get data amount. 

This function gets information on from our database, and returns either a webpage with the data or if specified, a J\+S\+ON Object with the number of indexed videos and channels. If no entries are found it returns 0.


\begin{DoxyParams}{Parameters}
{\em type} & Specify format, if this is blank it will return in H\+T\+ML format, if this key has the value \char`\"{}json\char`\"{} a json string will be returned. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Webpage or a J\+S\+ON dictionary like this one\+: \char`\"{}\{\char`\"{}channel\+\_\+count\char`\"{}\+:1,\char`\"{}video\+\_\+count\char`\"{}\+:2\}\char`\"{}
\end{DoxyReturn}
Examples\+: curl \href{http://localhost:5000/api/db-count?type=json}{\texttt{ http\+://localhost\+:5000/api/db-\/count?type=json}} Returns\+: \{\char`\"{}channel\+\_\+count\char`\"{}\+:1,\char`\"{}video\+\_\+count\char`\"{}\+:2\} 

Definition at line 401 of file index.\+py.

\mbox{\label{index_8py_a691b38ca85b1d82b54e4d1f82b811ff7}} 
...
\mbox{\label{index_8py_a7aba84fa123e655e0205c452394c8f25}} 
...
\mbox{\label{index_8py_a45f4a7cf23a65aec7bcfaaa75c07dce0}} 
...
\mbox{\label{index_8py_a43e0528a42ae3b457bed1db15d07ae7c}} 
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
The A\+PI documentation in pdf. Raises\+: 200 OK 
\end{DoxyReturn}


Definition at line 112 of file index.\+py.

\mbox{\label{index_8py_a03ea03ed8f4892134cd1b3a4fe171a33}} 
\index{index.py@{index.py}!submv@{submv}}
\index{submv@{submv}!index.py@{index.py}}
\doxysubsubsection{\texorpdfstring{submv()}{submv()}}
{\footnotesize\ttfamily def apimod.\+index.\+submv (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parameters}
{\em yturl} & Youtube U\+RL \\
\hline
{\em lbryurl} & L\+B\+RY U\+RL\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
204
...
Examples\+: curl -\/X P\+O\+ST -\/H \char`\"{}\+Content-\/\+Type\+: application/json\char`\"{} -\/d \textquotesingle{}\{\char`\"{}yturl\char`\"{}\+:Y\+T\+U\+RL,\char`\"{}lbryurl\char`\"{}\+:L\+B\+R\+Y\+U\+RL\}\textquotesingle{} \href{http://localhost:5000/api/submit-video}{\texttt{ http\+://localhost\+:5000/api/submit-\/video}} Returns\+: 204 
...
\mbox{\label{index_8py_aa5301e1f9d6a68c353222909ffcd124a}} 
