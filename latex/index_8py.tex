...
This function gets information on from our database, and returns a J\+S\+ON Object with the number of indexed videos and channels. If no entries are found it returns 0.
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
A J\+S\+ON dictionary like this one\+: \char`\"{}\{\char`\"{}channel\+\_\+count\char`\"{}\+:1,\char`\"{}video\+\_\+count\char`\"{}\+:2\}\char`\"{}
\end{DoxyReturn}
Examples\+: curl \href{http://localhost:5000/api/db-count}{\texttt{ http\+://localhost\+:5000/api/db-\/count}} Returns\+: \{\char`\"{}channel\+\_\+count\char`\"{}\+:1,\char`\"{}video\+\_\+count\char`\"{}\+:2\} 
...
Definition at line 440 of file index.\+py.
